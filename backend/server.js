...
app.use(cors({
    origin: ['http://localhost:3000', 'http://localhost:8080', 'http://127.0.0.1:3000', 'file://', 'http://projetoweb.luan.andrade.vms.ufsc.br', 'https://projetoweb.luan.andrade.vms.ufsc.br'],
    credentials: true
}));
