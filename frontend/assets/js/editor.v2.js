// Version: Thu Jun 26 02:43:02 PM UTC 2025
document.addEventListener('DOMContentLoaded', function() {
    ...
    function showLoggedInState() {
        ...
        // Mostrar o editor quando logado
    ...
    // ========================================
    async function init() {
        // Configurar botões de autenticação SEMPRE
        ...
        const isAuthenticated = await checkAuth(); if (!isAuthenticated) { document.querySelector(".editor-container").style.display = "none"; showNotification("Faça login ou registre-se para usar o JS Editor", "error"); return; }
